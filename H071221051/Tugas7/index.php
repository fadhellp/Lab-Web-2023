...
<body>  
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand text-white" href="index.php">UNIVERSITAS</a>
        </div>
                ...
                <li class="nav-item mt-1">
                    <div class="nav-link search-content">
                        <form class="row g-3" action="" method="post">
                            ...
                            <div class="col-auto">
                                <button type="submit" name="cari" class="btn btn-light">Search</button>
                            </div>
                        </form>
                    </div>
                </li>
    ...
    <section class="admin-section">
        <center>
            <div class="heading">
                <h1 class="sub-heading">Selamat Datang, <span><?= $_SESSION["pengguna"]; ?></span></h1>
                <h1 class="sub-heading">Daftar Mahasiswa</h1>
            </div>
            ...
            <div class="page-container text-center">
                <div class="prev-icon">
                    <?php if ($halamanAktif > 1) : ?>
                        <a class="fs-5 badge bg-danger text-wrap mx-3" href="?page=<?= $halamanAktif - 1; ?>"><i class='bx bx-chevron-left'></i></a>
                    <?php endif; ?>
                </div>
                ...
                <div class="next-icon">
                    <?php if ($halamanAktif < $jumlahHalaman) : ?>
                        <a class="fs-5 badge bg-danger text-wrap mx-3" href="?page=<?= $halamanAktif + 1; ?>"><i class='bx bx-chevron-right'></i></a>
                    <?php endif; ?>
                </div>
            </div>
